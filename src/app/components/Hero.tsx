  ...
  return (
    <section>
      ...
      <div className='px-3 hero-section'>
        <div className='relative pt-16 mx-auto max-w-7xl lg:pt-32 md:px-10'>
          <img
          ...
          <div className='flex'>
            <div className='relative'>
              ...
              <div className='mx-auto my-3'>
                <div className='relative z-[11]'>
                  ...
                  <span
                    className='absolute top-0 left-0 w-6 h-full home-campaign-glowing-icon-glow'
                    style={{
            ...
            <div className='absolute pt-32 ml-4 mt-28 max-md:px-4 md:ml-12'>
              <div className='relative md:top-20 mb-[24px]'>
                ...
                >
                  <div className='flex items-center p-3 px-5'>
                    <img
                      className='flex-grow-0 flex-shrink-0 w-auto mr-6 scale-110 d-block max-md:mr-3'
                      width='44'
                      height='44'
                      loading='lazy'
                      decoding='async'
                    ...
                    />
                    <div className='pr-3 md:pr-5 md:mr-2 md:pl-2'>
                    ...
                    <div className='ml-auto'>
                      <svg
                        ...
                        className={`  text-white transition ease-in duration-150 ${
                          isCopilotHovered ? 'translate-x-0 ' : '-translate-x-1'
                        }`}
                        width='16'
                        height='16'
                        viewBox='0 0 16 16'
                      ...
                      >
                        ...
                        <path
                          className={` text-white transition ease-in duration-150 ${
                            isCopilotHovered ? ' opacity-100' : 'opacity-0 '
                          }`}
                          stroke='currentColor'
                          d='M1.75 8H11'
                          strokeWidth='1.5'
              ...
              <div className='flex lg:w-11/12 md:space-x-5 max-md:flex-col'>
                ...
                <a
                  href=''
                  onMouseEnter={() => setIsTrialHovered(true)}
                  onMouseLeave={() => setIsTrialHovered(false)}
                ...
                >
                  ...
                  <svg
                    ...
                    className={` arrow-symbol-mktg text-white ml-3 transition ease-in duration-150 ${
                      isTrialHovered ? 'translate-x-0 ' : '-translate-x-1'
                    }`}
                    width='20'
                    height='20'
                    viewBox='0 0 16 16'
                  ...
                  >
                    ...
                    <path
                      className={` text-white transition ease-in duration-150 ${
                        isTrialHovered ? ' opacity-100' : 'opacity-0 '
                      }`}
                      stroke='currentColor'
                      d='M1.75 8H11'
                      strokeWidth='1.5'
