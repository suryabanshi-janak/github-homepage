...
const CopilotFeature = () => {
  ...
  const [selectedTab, setSelectedTab] = useState<TabType>('python');
  ...
  return (
    <div className='relative z-[1]'>
      <HoverCard backgroundColor='#7ee787' direction='' left='0'>
        <div className='flex-col justify-between flex-1 p-8 md:flex md:space-y-20 sm:p-10 lg:py-16 lg:pl-16 lg:pr-32'>
          <p className='text-xl md:text-2xl mb-6 font-medium text-[#7d8590]'>
            <span className='font-medium text-white'>GitHub Copilot</span> is
            your AI pair programmer that empowers you to complete tasks 55%
            faster by turning natural language prompts into coding suggestions.
          </p>
          <div>
            <a
                  ...
                  <div className='absolute w-full z-[1] bottom-[-60px] left-0 flex items-center justify-center mb-5'>
                    ...
                    >
                      <svg
                        ...
                        className='mr-2 octicon octicon-sync'
                      >
