const FooterContent = () => {
  return (
    <div className='footer relative pt-14 break-words'>
      <div className='max-w-7xl mx-auto relative z-[2] overflow-hidden'>
      ...
      <div className='bg-[#161b22]'>
        <div className='max-w-7xl mx-auto text-[12px] md:flex flex-row-reverse py-6 justify-between items-center px-4'>
          <ul className='flex items-center max-md:mb-4 gap-4'>
            <li>
              <a href=''>
                <img
          ...
          <ul className='flex items-center mb-4 sm:mb-0 text-[#7d8590] flex-wrap gap-3'>
